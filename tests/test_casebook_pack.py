"""Regression checks for the ledger-net-socket-forge casebook."""
...
from casebook.harness import assert_expected, ledger_net_socket_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ledger_net_socket_forge_summary(), assert_expected())
