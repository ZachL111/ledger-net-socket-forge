...
ledger-net-socket-forge is a TypeScript project for networking. It focuses on this technical goal: Design a TypeScript verification harness for socket systems, covering simulation kernel, seeded input scenarios, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 166, risk penalty 7, latency penalty 4, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
